...
class PostServiceTest {
    ...
    private Post testPostWithLongTet;
    ...
    void setUp() {
        ...
        testPostWithLongTet = new Post(2L, "Long Post", longText,
                Arrays.asList("long"), 0, 0);
    }
    ...
    void getPosts_shouldTruncateText_whenTextTooLong() {
        ...
        List<Post> posts = Arrays.asList(postWithLongText);
    ...
    void getPosts_shouldNotTruncateText_whenTextShort() {
        ...
        List<Post> posts = Arrays.asList(postWithShortText);
    ...
    void createPost_shouldSetDefaultCountersAndSave() {
        ...
        Post newPost = new Post(null, "New Post", "Content", Arrays.asList("tag1"), 999, 999);
        Post savedPost = new Post(1L, "New Post", "Content", Arrays.asList("tag1"), 0, 0);
        ...
        assertEquals(0, capturedPost.getCommentsCount());
        assertEquals("New Post", capturedPost.getTitle());
    ...
    void updatePost_shouldUpdateWithExistingCounters() {
        ...
        assertEquals(1L, capturedPost.getId());
        assertEquals("Updated Title", capturedPost.getTitle());
        assertEquals(5, capturedPost.getLikesCount()); // Сохранено из testPost
        assertEquals(2, capturedPost.getCommentsCount()); // Сохранено из testPost
    }
    ...
    void incrementLikes_shouldIncrementAndReturnCount() {
        ...
        assertEquals(5, result); // Исходное значение likesCount
    }
